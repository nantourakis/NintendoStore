...
namespace NintendoStore.Migrations
{
    ...
    [Migration("20200421234413_DescriptionTest")]
    partial class DescriptionTest
    {
            ...
            modelBuilder.Entity("NintendoStore.Models.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 50.00m,
                            ShortDescription = "A villain resembling Mario, known as Shadow Mario, vandalizes the island with graffiti as Mario gets blamed for the mess. Mario is ordered to clean up Isle Delfino, using a device called the Flash Liquidizer Ultra Dousing Device (F.L.U.D.D.), while saving Princess Peach from Shadow Mario."
                        },
                        new
                        {
                            GameId = 2,
